...
public class AccountCtrl extends AbstractControllerResource {

    public List<Account> getAll() {
        return getEntityManagerFactory().createEntityManager().createQuery("from Account").getResultList();
    }

    public Account getWithId(int resourceId) {
    ...
    public Account delete(Account a) throws Exception {
        Account verify = getWithId(a.getResourceId());
        if (verify != null) {
